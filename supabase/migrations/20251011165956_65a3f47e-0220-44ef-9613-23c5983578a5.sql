...
-- 2. Fix function with mutable search_path using CASCADE
...
COMMENT ON FUNCTION public.update_user_profiles_timestamp IS 'Trigger function with explicit search_path for security.';