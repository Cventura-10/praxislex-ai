-- =====================================================
-- SECURITY FIX: Field-Level PII Protection for Clients Table (Final)
-- =====================================================

-- 1. Drop existing get_clients_masked function if it exists with different signature
DROP FUNCTION IF EXISTS public.get_clients_masked(uuid);

-- 2. Add trigger to audit all write operations on clients table
...
-- 3. Create function to get safe (masked) client list for owners
...
-- 5. Create indexes on data_access_audit for better performance
